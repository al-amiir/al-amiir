...
<div style="display:flex ; align-items: flex-end; filter: drop-shadow(2px 4px 6px black)saturate(2.5) contrast(2);" >
...
- ⚡ Fun fact **I love animations, colors, coding and go to the GYM very often.**

<hr/>
<br/>
<br/>

<div style="display:flex ; align-items: flex-end; filter: drop-shadow(2px 4px 6px black);" >
...
<div style="display:flex ;justify-content:center;"> 
    ...
    <!-- <a style="margin-right:10px" href="https://spring.io/projects/spring-boot" target="_blank"> <img src="https://img.icons8.com/color/48/000000/spring-logo.png"/> </a>  -->
    <a style="margin-right:10px" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target="_blank"> <img width="50px" src="https://img.icons8.com/color/48/000000/javascript.png"/> </a> 
    ...
    <!-- <a style="margin-right:10px" href="https://firebase.google.com/" target="_blank"> <img width="50px" src="https://img.icons8.com/color/48/000000/firebase.png"/> </a>  -->
    ...
    <!-- <a style="margin-right:10px" href="https://www.jenkins.io" target="_blank"> <img width="50px" src="https://www.vectorlogo.zone/logos/jenkins/jenkins-icon.svg" alt="jenkins" width="48" height="48"/> </a>  -->
...
<p style="font-size:20px ; margin-left:10px" > my github stats:</p>
</div>
  <br/>
...
<div style="display:flex ; align-items: flex-end; filter: drop-shadow(2px 4px 6px black) saturate(1.5);" >
...
<p style="font-size:20px ; margin-left:10px" > connect with me:</p>
</div>
<br/>
...
<a href="https://github.com/Meghna-DAS/github-profile-views-counter">
    <img src="https://komarev.com/ghpvc/?username=al-amiir">
</a>
<a href="https://github.com/al-amiir?tab=followers"><img src="https://img.shields.io/github/followers/al-amiir?label=Followers&style=social" alt="GitHub Badge"></a> -->
